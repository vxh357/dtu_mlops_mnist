...
class MyNeuralNet(nn.Module):
    ...
    def __init__(self, model_hparams: dict, in_features: int, out_features: int) -> None:
        ...
        self.fc1 = nn.Linear(in_features, model_hparams["l1_dim"])      # First layer with 'in_features' inputs and 256 outputs
        ...
        self.fc2 = nn.Linear(model_hparams["l1_dim"], model_hparams["l2_dim"])      # Second layer with 256 inputs and 128 outputs
        ...
        self.fc3 = nn.Linear(model_hparams["l2_dim"], model_hparams["l3_dim"])      # Third layer with 128 inputs and 64 outputs
        ...
        self.fc4 = nn.Linear(model_hparams["l3_dim"], out_features)         # Final layer with 64 inputs and 'out_features' outputs
